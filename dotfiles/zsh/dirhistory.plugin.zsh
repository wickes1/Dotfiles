...
for keymap in emacs vicmd viins; do
  ...
  bindkey -M $keymap "\eh" dirhistory_zle_dirhistory_back  # xterm in normal mode
  ...
  bindkey -M $keymap "\el" dirhistory_zle_dirhistory_future  # xterm in normal mode
...
for keymap in emacs vicmd viins; do
  ...
  bindkey -M $keymap "\ek" dirhistory_zle_dirhistory_up  # xterm in normal mode
  ...
  bindkey -M $keymap "\ej" dirhistory_zle_dirhistory_down  # xterm in normal mode
